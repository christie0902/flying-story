    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-9">
            ...
            <form action="{{ route('lessons.update', $lesson->id) }}" method="POST">
                ...
                @if($relatedLessons->isNotEmpty())
                <h5 class="sub-title my-3">This class is part of a recurring series. Here are the other classes:</h5>
                <div class="row mb-2">
                ...
                <button type="submit" class="btn btn-primary w-100 my-3">Update Class</button>
            </form>
        </div>
    </div>
</div>
